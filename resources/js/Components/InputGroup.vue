<template>
        ...
        <div class="relative text-gray-900 focus-within:text-purple-600 dark:focus-within:text-blue-400">
                  <input class="block w-full pl-10 mt-1 text-sm text-black dark:text-gray-600 dark:border-gray-600 dark:bg-white focus:border-blue-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" placeholder="Jane Doe">
